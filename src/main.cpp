...
uint256 hashGenesisBlock("0x35cc1ab99e07be413c5a82d41a0b9680ab376f7fce68d8a0767b5bf84308f8e1");
...
static const int64 nTargetTimespan = 3 * 24 * 60 * 60; // Peacecoin: 3 days
static const int64 nTargetSpacing = 2.5 * 60; // Peacecoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf9dca8e89d9d4440319af0accd5c752649814b10d861050ca26fa2d4687537c8");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = " 26/11/2020 - The PeaceCoin genesis block was made.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 60 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04cc51f7c4d03abdccb7aadf30f7a556f1f64936dfc757b64fec24f029c5d1c6fdffb511594182750990ff8ac7f9657e8b152c651348ad866b5d9b024165ff4565") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1606405855;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085895792;

        if (fTestNet)
        {
            block.nTime    = 1606405815;
            block.nNonce   = 386436163;
        }
...
if (true && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xc18d442e7b7559ffd621fdfc727fbb18e25456fa34e9571fe84e64496228a920"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfd, 0xc4, 0xb9, 0xdf }; // Peacecoin: increase each by adding 2 to bitcoin's value.
